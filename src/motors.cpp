...
void motors::PID_encoders(int targetSpeed,int i){
...
void motors::ahead_ultra(){
    ...
    PID_encoders(speedReference-error,MotorID::kFrontLeft);
    PID_encoders(speedReference-error,MotorID::kBackLeft);
    PID_encoders(speedReference+error,MotorID::kFrontRight);
    PID_encoders(speedReference+error,MotorID::kBackRight);
}
// void motors::ahead(){
