...
# import cv2
# import numpy as np
# input_path="C:\\Users\\ferna\\Documents\\robocup-rescuemaze-2025-4\\fotos\\Ndataset2\\S"
# outputh_path="C:\\Users\\ferna\\Documents\\robocup-rescuemaze-2025-4\\contourDataset2\\S"
# os.makedirs(outputh_path,exist_ok=True)#crear carpeta si no ha sido creada
...
#         mask_no_lights = cv2.bitwise_not(mask_lights)
#         # Find edges
#         edges = cv2.Canny(gray, threshold1=5, threshold2=50)  
#         edges = cv2.bitwise_and(edges, edges, mask=mask_no_lights)
#         # Expand edges
#         kernel=np.ones((15,15),np.uint8)
#         edges=cv2.dilate(edges,kernel,iterations=1)
#         # Find Contours
#         contours, _=cv2.findContours(edges,cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
#         contours = [c for c in contours if cv2.contourArea(c) > 7000]#delete small contours
...
# origen = "C:\\Users\\ferna\\Documents\\robocup-rescuemaze-2025-4\\contourDataset\\U"
# destino = "C:\\Users\\ferna\\Documents\\robocup-rescuemaze-2025-4\\contourDataset\\U"
