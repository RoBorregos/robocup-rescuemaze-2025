...
# load image
# img = cv2.imread("C:\\Users\\ferna\\Documents\\robocup-rescuemaze-2025-4\\fotos\\Ndataset2\\S\\foto_000.jpg")
img = cv2.imread("C:\\Users\\ferna\\Downloads\\h6.jpg")
...
# Find edges
edges = cv2.Canny(gray, threshold1=50, threshold2=90)  
...
# image = (image[0] * 255).astype(np.uint8) #Make prediction
